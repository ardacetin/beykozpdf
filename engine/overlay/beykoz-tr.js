(function () {
  const copy = new Map(Object.entries({
    ...
    'Remove Blank Pages': 'Boş Sayfaları Kaldır',
    'Deskew PDF': 'PDF Eğriliğini Düzelt',
    'Compare PDFs': "PDF'leri Karşılaştır",
    'PDF Form Filler': 'PDF Form Doldurucu',
    'Header & Footer': 'Üst Bilgi ve Alt Bilgi',
    ...
    'Convert PDF files to editable Word documents.': 'PDF dosyalarını düzenlenebilir Word belgelerine dönüştürün.',
    'Extract tables from PDF and convert to Excel (XLSX) format.': 'PDF tablolarını çıkarın ve Excel (XLSX) biçimine dönüştürün.',
    'Extract text from PDF files and save as plain text (.txt). Supports multiple files.': "PDF dosyalarındaki metni çıkarıp düz metin (.txt) olarak kaydedin. Birden fazla dosya desteklenir.",
    'Extract all embedded images from your PDF files.': 'PDF dosyalarınızdaki tüm gömülü görselleri çıkarın.',
    'Recover data from corrupted or damaged PDF files.': 'Bozuk veya hasarlı PDF dosyalarındaki verileri kurtarın.',
    'Automatically detect and delete blank pages.': 'Boş sayfaları otomatik olarak tespit edip silin.',
    'Automatically straighten tilted scanned pages using OpenCV.': 'Eğik taranmış sayfaları OpenCV ile otomatik olarak düzeltin.',
    'Compare two PDFs side by side.': "İki PDF'yi yan yana karşılaştırın.",
    'Fill in forms directly in the browser. Also supports XFA forms.': 'Formları doğrudan tarayıcıda doldurun. XFA formları da desteklenir.',
    'Add text to the top and bottom of pages.': 'Sayfaların üst ve alt kısmına metin ekleyin.',
    'Generate a table of contents page from PDF bookmarks.': 'PDF yer imlerinden bir içindekiler sayfası oluşturun.',
    ...
    'Convert to DOCX': 'Word Belgesine Dönüştür',
    'Convert to Excel': "Excel'e Dönüştür",
    'Extract Text': 'Metni Çıkar',
    'Clear Files': 'Dosyaları Temizle',
    'Extracted Images': 'Çıkarılan Görseller',
    'Download All (ZIP)': 'Tümünü İndir (ZIP)',
    'Sensitivity:': 'Hassasiyet:',
    'Higher = stricter, only purely blank pages. Lower = allows pages with some content.': 'Yüksek değer yalnızca tamamen boş sayfaları seçer; düşük değer az miktarda içerik bulunan sayfalara izin verir.',
    ...
    'PDF file with form fields': 'Form alanları içeren PDF dosyası',
    'Upload a PDF with form fields. Fill them directly in the viewer below, then click the button to save and download the filled form. Also supports XFA forms.': 'Form alanları içeren bir PDF yükleyin. Alanları aşağıdaki görüntüleyicide doldurun, ardından doldurulmuş formu kaydedip indirin. XFA formları da desteklenir.',
    'Note on XFA Forms:': 'XFA Formları Hakkında:',
    "XFA (XML Forms Architecture) is a legacy format that's only supported by certain PDF viewers like BentoPDF and Firefox. If you open an XFA PDF in other software and see blank pages or no form fields, it means that viewer doesn't support XFA. To view and fill XFA forms properly, use Firefox or BentoPDF's Form Filler.": "XFA (XML Forms Architecture), yalnızca Firefox ve bu araç gibi belirli PDF görüntüleyicilerinin desteklediği eski bir form biçimidir. Başka bir programda boş sayfalar veya eksik form alanları görürseniz program XFA'yı desteklemiyor olabilir. XFA formlarını görüntülemek ve doldurmak için Firefox'u veya bu form doldurma aracını kullanın.",
    ...
    'Add Header & Footer': 'Üst Bilgi ve Alt Bilgi Ekle',
    'TOC Title': 'İçindekiler Başlığı',
    'Font Family': 'Yazı Tipi',
    'Add bookmark for TOC page': 'İçindekiler sayfası için yer imi ekle',
    'Generate Table of Contents': 'İçindekiler Oluştur',
    'e.g., 1-3, 5': 'ör. 1-3, 5',
    'Convert': 'Dönüştür',
    ...
    'Loading PDF converter...': 'PDF dönüştürücü yükleniyor...',
    'Extracting text...': 'Metin çıkarılıyor...',
    'Extracting images...': 'Görseller çıkarılıyor...',
    'Repairing PDF...': 'PDF onarılıyor...',
    'Detecting blank pages...': 'Boş sayfalar bulunuyor...',
    'Removing blank pages...': 'Boş sayfalar kaldırılıyor...',
    'Adding header & footer...': 'Üst bilgi ve alt bilgi ekleniyor...',
    'Converting...': 'Dönüştürülüyor...',
    'Creating ZIP archive...': 'ZIP arşivi oluşturuluyor...',
  ...
  const patterns = [
    ...
    [/^Successfully converted (\d+) PDF\(s\) to DOCX\.$/, (_m, count) => `${count} PDF başarıyla Word belgesine dönüştürüldü.`],
    [/^Successfully converted (.+) to DOCX\.$/, (_m, file) => `${file} başarıyla Word belgesine dönüştürüldü.`],
    ...
    [/^Converting (.+)\.\.\.$/, (_m, file) => `${file} dönüştürülüyor...`],
    [/^(.+) • (\d+) pages$/, (_m, size, count) => `${size} • ${count} sayfa`],
